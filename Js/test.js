const {searchByName, searchByProductsName,filterByCategory, filterByPrice,totalPriceCal, addProduct}= require('./main.js');
...
describe('Testing adding new item', () => {
  test('should return array with two objects',()=>{
